	...
	<div class="page-inner">
		<div class="page-header">
			...
			<ul class="breadcrumbs">
				...
				<li class="nav-item">
					<a href="#">@lang("admin_messages.agencies")</a>
				</li>
			</ul>
		</div>
		<div class="row">
				...
				<div class="card">
					<div class="card-header">
						<div class="d-flex align-items-center">
							...
							@checkPermission('create-agencies')
							<a class="btn btn-primary btn-round ml-auto" href="{{ route('admin.agencies.create') }}">
								<i class="fa fa-plus"></i>
								@lang("admin_messages.add_agency")
							</a>
							@endcheckPermission
						</div>
					</div>
